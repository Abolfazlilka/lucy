...
enum class TokenType {
 ...
 If,Else,While,For,Foreach,Loop,Function,Def,Class,Return,Break,Continue,End,
 ...
 Greater,GreaterEqual,Less,LessEqual,BitAnd,BitOr,BitXor,BitNot,ShiftLeft,ShiftRight,
 ...
 LeftParen,RightParen,LeftBracket,RightBracket,LeftBrace,RightBrace,Comma,Newline,EndOfFile
};
